...
class UnstructuredRow:
    ...
    def __str__(self) -> str:
        return "\n".join([str(content) for _, content in self.data if content is not None])
...
class UnstructuredTable(Table): 
    ...
    def __init__(
        self, 
        data: List[UnstructuredRow] = None,
        **kwargs
    ):
        self.data = data or []
        ...
        **kwargs
        ...
        if metadata is None:
            metadata = ElementMetadata(
                ...
                page_name=kwargs.pop("page_name", data.Name if hasattr(data, 'Name') else None),
